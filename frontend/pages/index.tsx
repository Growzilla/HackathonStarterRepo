...
export default function HomePage() {
  const { data: storeData } = useApi(() => api.getStore(), [])
      ...
      <div className="space-y-8 max-w-4xl mx-auto">
        ...
        {storeData && (
          <div className="grid grid-cols-3 gap-3">
            <KPICard title="Products" value={formatNumber(storeData.product_count)} tooltip="Products in your store" />
            <KPICard title="Orders" value={formatNumber(storeData.order_count)} tooltip="Total orders tracked" />
            <KPICard title="Customers" value={formatNumber(storeData.customer_count)} tooltip="Total customers" />
          </div>
        )}
